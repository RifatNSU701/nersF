...
const ConsumerDashboard=()=>{
  ...
  return <div className="min-h-screen bg-slate-50 p-6 md:p-10"><div className="max-w-7xl mx-auto">
    ...
    <section className="grid md:grid-cols-3 gap-5 mb-8">
      ...
      <Link to="/consumer/helpdesk" className="bg-white border rounded-2xl p-6 shadow-sm hover:shadow-md"><MessageSquare className="h-8 w-8 text-blue-700 mb-4"/><h2 className="font-bold">24/7 Help Desk</h2><p className="text-sm text-slate-500 mt-2">Create support requests and chat with support agents.</p><span className="mt-5 text-sm font-bold text-blue-700 flex items-center gap-1">Open Help Desk <ArrowRight className="h-4 w-4"/></span></Link>
    </section>
